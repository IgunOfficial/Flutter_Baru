          ...
          children: [
            Center(
              child: Container(
                ...
                child: Image.network(
                  'https://i.ibb.co/2dt0xBp/LM-405.jpg',
                  fit: BoxFit.cover,
                  width: 200,
                  height: 200,
                ),
            ...
            const SizedBox(height: 10),
            const Text(
              'Irfan Gunawan, I am 18 years old. My hobby is playing futsal.',
              style: TextStyle(
                fontSize: 16,
              ),
            ),
            ...
            GestureDetector(
              onTap: () {
                ...
                launch('https://www.facebook.com/irfan.tablo.79/');
              },
              child: Row(
                children: const [
                  Icon(Icons.facebook),
            ...
            GestureDetector(
              onTap: () {
                // ignore: deprecated_member_use
                launch('https://www.instagram.com/bampres_/');
              },
              child: Row(
                children: const [
                  Icon(Icons.email),
